...
bit-field of type \texttt{T$^\prime$} if there exists an implicit conversion from
\texttt{T} to \texttt{T$^\prime$}.  After the conversion from \texttt{T} to
\texttt{T$^\prime$} the value is truncated to the size of the bit-field.
