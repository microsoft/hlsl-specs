...
\begin{itemize}
\item If a name has \textit{no linkage}, it may not be referred to by names from
any other scope.
\item If a name has \textit{internal linkage}, it may be referred to by names
from other scopes within the same translation unit.
\item If a name has \textit{external linkage}, may be referred to by names from
