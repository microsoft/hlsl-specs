...
together with a way for shader authors to declare the maximum amount of group
...
### Relaxing Validation for `insertvalue`

Beginning with DXIL 1.10, validation permits the `insertvalue` instruction for
structure values. The aggregate operand may be `undef`; any members not replaced
by the instruction remain undefined. This relaxation allows unoptimized code to
construct structures in SSA form and pass validation.
...
[Proposal 0048]: 0048-group-wave-index.md
[Proposal 0049]: 0049-variable-groupshared-memory.md
